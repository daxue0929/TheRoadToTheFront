var cleanUpSelectors = require('clean-css/lib/selectors/clean-up').selectors;
var cleanUpBlock = require('clean-css/lib/selectors/clean-up').block;
var cleanUpAtRule = require('clean-css/lib/selectors/clean-up').atRule;
var split = require('clean-css/lib/utils/split');

var RGB = require('clean-css/lib/colors/rgb');
var HSL = require('clean-css/lib/colors/hsl');
var HexNameShortener = require('clean-css/lib/colors/hex-name-shortener');
