var extractProperties = require('clean-css/lib/selectors/extractor');
var canReorderSingle = require('clean-css/lib/selectors/reorderable').canReorderSingle;
var stringifyBody = require('clean-css/lib/stringifier/one-time').body;
var stringifySelectors = require('clean-css/lib/stringifier/one-time').selectors;
var cleanUpSelectorDuplicates = require('clean-css/lib/selectors/clean-up').selectorDuplicates;
var isSpecial = require('clean-css/lib/selectors/is-special');
