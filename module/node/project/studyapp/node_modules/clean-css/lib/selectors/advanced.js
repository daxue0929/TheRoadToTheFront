var optimizeProperties = require('clean-css/lib/properties/optimizer');

var removeDuplicates = require('clean-css/lib/selectors/remove-duplicates');
var mergeAdjacent = require('clean-css/lib/selectors/merge-adjacent');
var reduceNonAdjacent = require('clean-css/lib/selectors/reduce-non-adjacent');
var mergeNonAdjacentBySelector = require('clean-css/lib/selectors/merge-non-adjacent-by-selector');
var mergeNonAdjacentByBody = require('clean-css/lib/selectors/merge-non-adjacent-by-body');
var restructure = require('clean-css/lib/selectors/restructure');
var removeDuplicateMediaQueries = require('clean-css/lib/selectors/remove-duplicate-media-queries');
var mergeMediaQueries = require('clean-css/lib/selectors/merge-media-queries');
