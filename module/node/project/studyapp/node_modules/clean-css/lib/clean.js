...
var ImportInliner = require('clean-css/lib/imports/inliner');
var rebaseUrls = require('clean-css/lib/urls/rebase');

var tokenize = require('clean-css/lib/tokenizer/tokenize');
var simpleOptimize = require('clean-css/lib/selectors/simple');
var advancedOptimize = require('clean-css/lib/selectors/advanced');

var simpleStringify = require('clean-css/lib/stringifier/simple');
var sourceMapStringify = require('clean-css/lib/stringifier/source-maps');

var CommentsProcessor = require('clean-css/lib/text/comments-processor');
var ExpressionsProcessor = require('clean-css/lib/text/expressions-processor');
var FreeTextProcessor = require('clean-css/lib/text/free-text-processor');
var UrlsProcessor = require('clean-css/lib/text/urls-processor');

var Compatibility = require('clean-css/lib/utils/compatibility');
var InputSourceMapTracker = require('clean-css/lib/utils/input-source-map-tracker');
var SourceTracker = require('clean-css/lib/utils/source-tracker');
var SourceReader = require('clean-css/lib/utils/source-reader');
var Validator = require('clean-css/lib/properties/validator');

var fs = require('fs');
var path = require('path');
var url = require('url');

var override = require('clean-css/lib/utils/object').override;
