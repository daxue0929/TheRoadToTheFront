var canOverride = require('clean-css/lib/properties/can-override');
var compactable = require('clean-css/lib/properties/compactable');
var deepClone = require('clean-css/lib/properties/clone').deep;
var shallowClone = require('clean-css/lib/properties/clone').shallow;
var hasInherit = require('clean-css/lib/properties/has-inherit');
var restoreFromOptimizing = require('clean-css/lib/properties/restore-from-optimizing');
var everyCombination = require('clean-css/lib/properties/every-combination');
var sameVendorPrefixesIn = require('clean-css/lib/properties/vendor-prefixes').same;

var stringifyProperty = require('clean-css/lib/stringifier/one-time').property;
